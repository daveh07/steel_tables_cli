#!/bin/bash
# macOS command file to run steel_tables in Terminal
# Place this file in the same directory as steel_tables (macOS binary)
# Make executable with: chmod +x run_steel_tables.command
...
if [ ! -f "./steel_tables" ]; then
    ...
    echo "Please make sure steel_tables (macOS binary) is in the same folder as this script."
    echo ""
